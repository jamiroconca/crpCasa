...
require_once 'modules/crpCasa/pnincludes/Picasa/Image.php';
require_once 'modules/crpCasa/pnincludes/Picasa/ImageCollection.php';
require_once 'modules/crpCasa/pnincludes/Picasa/Album.php';
require_once 'modules/crpCasa/pnincludes/Picasa/Account.php';
require_once 'modules/crpCasa/pnincludes/Picasa/Comment.php';
require_once 'modules/crpCasa/pnincludes/Picasa/Tag.php';
require_once 'modules/crpCasa/pnincludes/Picasa/Author.php';
require_once 'modules/crpCasa/pnincludes/Picasa/Exception.php';
require_once 'modules/crpCasa/pnincludes/Picasa/Logger.php';
require_once 'modules/crpCasa/pnincludes/Picasa/Exception/CaptchaRequiredException.php';
require_once 'modules/crpCasa/pnincludes/Picasa/Exception/UnauthorizedException.php';
require_once 'modules/crpCasa/pnincludes/Picasa/Exception/BadRequestException.php';
require_once 'modules/crpCasa/pnincludes/Picasa/Exception/FailedAuthorizationException.php';
require_once 'modules/crpCasa/pnincludes/Picasa/Exception/FileNotFoundException.php';
require_once 'modules/crpCasa/pnincludes/Picasa/Exception/InternalServerErrorException.php';
require_once 'modules/crpCasa/pnincludes/Picasa/Exception/ConflictException.php';
require_once 'modules/crpCasa/pnincludes/Picasa/Exception/InvalidUsernameOrPasswordException.php';
